...
MOD_CSRC   := $(SRC)/modules/mod_emit.c $(SRC)/modules/file_access_classify.c $(SRC)/modules/ransomware_burst_classify.c $(SRC)/modules/a11y_abuse_classify.c $(SRC)/modules/mediaproj_abuse_parse.c $(SRC)/modules/proc_event.c $(SRC)/modules/execve.c $(SRC)/modules/prop_read.c $(SRC)/modules/file_access.c $(SRC)/modules/ransomware_burst.c $(SRC)/modules/exfil_burst.c $(SRC)/modules/a11y_abuse.c $(SRC)/modules/fileless_exec.c $(SRC)/modules/mod.c
