...
// Single-process rename+unlink burst trigger for the `mod massdelete-detect`
...
// massdelete_detect.bpf.c keys per calling PID, so touches split across many
// short-lived subprocesses never accumulate to MASSDELETE_DETECT_THRESHOLD.
#include <fcntl.h>
#include <stdio.h>
#include <unistd.h>
#include <sys/stat.h>
