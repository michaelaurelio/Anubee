...
// Userspace JSON emitter for the shared ares_stack_snapshot. Pure (no libbpf /
...
void ares_stack_snapshot_emit_json(struct jbuf *j, const struct ares_stack_snapshot *s)
{
