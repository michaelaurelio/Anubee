...
$(BUILD)/modules/%.o: $(SRC)/modules/%.c $(PROC_EVENT_SKEL) $(EXECVE_SKEL) $(PROP_READ_SKEL) $(FILE_ACCESS_SKEL) $(RANSOMWARE_BURST_SKEL) $(EXFIL_BURST_SKEL) $(A11Y_ABUSE_SKEL) $(LIBBPF_A)
	mkdir -p $(dir $@)
	$(CC) $(MOD_CFLAGS) -c $< -o $@
