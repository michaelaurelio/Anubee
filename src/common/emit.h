...
// serialize all jb-build + anubee_sink_emit calls under an external mutex.
// anubee_sink_flush (fflush only) is safe to call unlocked from any thread.
struct anubee_sink {
    FILE               *f;
