...
// mediaproj-abuse analyzer's poll thread (mediaproj_abuse.c) to detect an
...
// tests/test_mediaproj_abuse_parse.c).
#ifndef __ARES_MEDIAPROJ_ABUSE_PARSE_H
#define __ARES_MEDIAPROJ_ABUSE_PARSE_H
...
#define MEDIAPROJ_FGS_TYPE_BIT 0x20
...
#endif /* __ARES_MEDIAPROJ_ABUSE_PARSE_H */
